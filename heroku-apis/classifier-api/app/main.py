...
campaign_encoder.classes_ = np.load('app/campaign.npy',allow_pickle = True)

device_category_encoder = preprocessing.LabelEncoder()
device_category_encoder.classes_ = np.load('app/device_category.npy',allow_pickle = True)

social_network_encoder = preprocessing.LabelEncoder()
social_network_encoder.classes_ = np.load('app/social_network.npy',allow_pickle = True)

shopping_stage_encoder = preprocessing.LabelEncoder()
shopping_stage_encoder.classes_ = np.load('app/shopping_stage.npy',allow_pickle = True)



loaded_model = pkl.load(open('app/model.pickle.dat', "rb"))
