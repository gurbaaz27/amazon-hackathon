...
async function learner(a)
{
  ...
  book_name = document.getElementById(a).innerHTML;
  var Data = {
    ...
    cost : Math.floor(randomNumber(0,10)),
    probability : randomNumber(0,1)
};
console.log(Data);
const url = 'https://cors-amazon.herokuapp.com/https://bandits-api.herokuapp.com/learn';
const params = {
